...
public class OregonGardenLibrary {
    ...
    public OregonGardenLibrary() {
        ...
        gardenTextBodiesArray[11] = "The Northwest Garden's landscape design showcases plants and trees that thrive in our region. Visitors experience meandering pathways through lush garden beds filled with color, texture, form and movement. Highlights include a large pergola covered in vines and an area created in partnership with Monrovia nursery. This was one of our first completed gardens and is an excellent place to spend some time if you are looking for ideas in your own Northwest landscape.";
        gardenTextBodiesArray[12] = "A spectacular 25-acre native oak grove lives in the Garden and is home to many trees more than 100 years old. The 100-foot-high Signature Oak is 400 years old and its massive branches touch the ground in several places. It has been designated as one of Oregon's 'Heritage Trees'.\n" +
